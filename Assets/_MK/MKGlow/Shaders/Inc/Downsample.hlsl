...
//////////////////////////////////////////////////////
	...
	HEADER
	{
		...
		#ifdef MK_LENS_FLARE
			LENS_FLARE_RENDER_TARGET = DownsampleLQ(PASS_TEXTURE_2D(_LensFlareTex, sampler_LensFlareTex), LENS_FLARE_UV, LENS_FLARE_TEXEL_SIZE);
		#endif

		#ifdef MK_GLARE
			GLARE0_RENDER_TARGET = DownsampleLQ(PASS_TEXTURE_2D(_Glare0Tex, sampler_Glare0Tex), GLARE_UV, GLARE0_TEXEL_SIZE);
		#endif
